+++
title = "Kabuso | Howl's Moving Contract"
track = "tooling"
excellence_award_track = "social_impact" # Can be empty
team = "/teams/973"
+++

# Kabuso | Howl's Moving Contract

### Track: tooling
#### Excellence Award Track: social_impact

### Team: [Howl's Moving Contract](@/teams/973.md)
...
#### Links
- [Repository](https://github.com/VMLVaske/Kabuso)
- [Pitch Deck](https://docs.google.com/presentation/d/13UFmokjrK8uSPYJ8riIoTF2ZtZYOLQRGUdvXU1N7T9w/edit?usp=sharing)
